...
-(void) setUpAutoModeView
{
    ...
    [relexBtn setBackgroundImage:[[UIImage imageNamed:@"bg_btn_line_normal.png"] stretchableImageWithLeftCapWidth:12 topCapHeight:12] forState:UIControlStateNormal];
    [relexBtn setTitle:@"Relaxation" forState:UIControlStateNormal];
    [relexBtn setBackgroundColor:[UIColor grayColor]];
    ...
    [sleepBtn setBackgroundImage:[[UIImage imageNamed:@"bg_btn_line_normal.png"] stretchableImageWithLeftCapWidth:12 topCapHeight:12] forState:UIControlStateNormal];
    [sleepBtn setTitle:@"Sleep" forState:UIControlStateNormal];
    [sleepBtn setBackgroundColor:[UIColor blueColor]];
    sleepBtn.tag = 2;
    ...
    [energBtn setBackgroundImage:[[UIImage imageNamed:@"bg_btn_line_normal.png"] stretchableImageWithLeftCapWidth:12 topCapHeight:12] forState:UIControlStateNormal];
    [energBtn setTitle:@"Energization" forState:UIControlStateNormal];
    [energBtn setBackgroundColor:[UIColor blueColor]];
    ...
    [soothBtn setBackgroundImage:[[UIImage imageNamed:@"bg_btn_line_normal.png"] stretchableImageWithLeftCapWidth:12 topCapHeight:12] forState:UIControlStateNormal];
    [soothBtn setTitle:@"Soothing" forState:UIControlStateNormal];
    [soothBtn setBackgroundColor:[UIColor blueColor]];
    ...
    [sensuBtn setBackgroundImage:[[UIImage imageNamed:@"bg_btn_line_normal.png"] stretchableImageWithLeftCapWidth:12 topCapHeight:12] forState:UIControlStateNormal];
    [sensuBtn setTitle:@"Sensuality" forState:UIControlStateNormal];
    [sensuBtn setBackgroundColor:[UIColor blueColor]];
    ...
    [concenBtn setBackgroundImage:[[UIImage imageNamed:@"bg_btn_line_normal.png"] stretchableImageWithLeftCapWidth:12 topCapHeight:12] forState:UIControlStateNormal];
    [concenBtn setTitle:@"Concentration" forState:UIControlStateNormal];
    [concenBtn setBackgroundColor:[UIColor blueColor]];
...
-(void)setUpUserModeView
{
    ...
    [twoBtn setBackgroundImage:[[UIImage imageNamed:@"bg_btn_line_normal.png"] stretchableImageWithLeftCapWidth:12 topCapHeight:12] forState:UIControlStateNormal];
    ...
    [fourBtn setBackgroundImage:[[UIImage imageNamed:@"bg_btn_line_normal.png"] stretchableImageWithLeftCapWidth:12 topCapHeight:12] forState:UIControlStateNormal];
    [fourBtn setTitle:@"4 Hours" forState:UIControlStateNormal];
    [fourBtn setBackgroundColor:[UIColor blueColor]];
    ...
    [threeBtn setBackgroundImage:[[UIImage imageNamed:@"bg_btn_line_normal.png"] stretchableImageWithLeftCapWidth:12 topCapHeight:12] forState:UIControlStateNormal];
    [threeBtn setTitle:@"8 Hours" forState:UIControlStateNormal];
    [threeBtn setBackgroundColor:[UIColor blueColor]];
    ...
    [sixBtn setBackgroundImage:[[UIImage imageNamed:@"bg_btn_line_normal.png"] stretchableImageWithLeftCapWidth:12 topCapHeight:12] forState:UIControlStateNormal];
    [sixBtn setTitle:@"16 Hour" forState:UIControlStateNormal];
    [sixBtn setBackgroundColor:[UIColor blueColor]];
